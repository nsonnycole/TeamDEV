...
class Projet extends \AppBundle\Entity\Projet implements \Doctrine\ORM\Proxy\Proxy
{
     ...
     */
    public static $lazyPropertiesDefaults = ['url' => NULL];
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'nomProjet', 'description', 'contenu', '' . "\0" . 'AppBundle\\Entity\\Projet' . "\0" . 'dateDebut', 'dateFin', 'duree', 'nbPlaces', 'nbParticipants', 'statut', 'idUtilisateur', 'idTypeProjet', 'url', 'technologies', '' . "\0" . 'AppBundle\\Entity\\Projet' . "\0" . 'file'];
        }

        return ['__isInitialized__', 'id', 'nomProjet', 'description', 'contenu', '' . "\0" . 'AppBundle\\Entity\\Projet' . "\0" . 'dateDebut', 'dateFin', 'duree', 'nbPlaces', 'nbParticipants', 'statut', 'idUtilisateur', 'idTypeProjet', 'technologies', '' . "\0" . 'AppBundle\\Entity\\Projet' . "\0" . 'file'];
    }
    ...
    public function addIdTypeProjet(\AppBundle\Entity\TypeProjet $idTypeProjet)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addIdTypeProjet', [$idTypeProjet]);

        return parent::addIdTypeProjet($idTypeProjet);
    }
    ...
    public function removeIdTypeProjet(\AppBundle\Entity\TypeProjet $idTypeProjet)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeIdTypeProjet', [$idTypeProjet]);

        return parent::removeIdTypeProjet($idTypeProjet);
    }

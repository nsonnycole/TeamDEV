...
class Projet extends \AppBundle\Entity\Projet implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'nomProjet', 'description', 'contenu', '' . "\0" . 'AppBundle\\Entity\\Projet' . "\0" . 'dateDebut', 'dateFin', 'duree', 'nbPlaces', 'nbParticipants', 'statut', 'idUtilisateur', 'idTypeProjet', 'url', 'pictureName', 'file', 'technologies'];
        }

        return ['__isInitialized__', 'id', 'nomProjet', 'description', 'contenu', '' . "\0" . 'AppBundle\\Entity\\Projet' . "\0" . 'dateDebut', 'dateFin', 'duree', 'nbPlaces', 'nbParticipants', 'statut', 'idUtilisateur', 'idTypeProjet', 'file', 'technologies'];
    }
